...
class UploadHealthReportScreen extends StatefulWidget {
  ...
  const UploadHealthReportScreen({super.key, required this.userId});
  
  @override
  _UploadHealthReportScreenState createState() =>
      _UploadHealthReportScreenState();
}
...
class _UploadHealthReportScreenState extends State<UploadHealthReportScreen> {
  ...
  Future<void> _uploadImage(BuildContext context) async {
    try {
      ...
      String url = 'http://10.0.2.2:5000/uploadhealthrecord';
