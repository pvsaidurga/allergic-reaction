          ...
          content: Material(
            ...
            child: Container(
              ...
              child: ListView(
                shrinkWrap: true,
                children: [
                  _foodOrBodyCareOption('assets/makeuse51.jpg', 'Soap'),
                  _foodOrBodyCareOption('assets/makeuse52.jpg', 'FaceCream'),
                  _foodOrBodyCareOption('assets/makeuse53.jpg', 'HandWash'),
                  _foodOrBodyCareOption('assets/makeuse54.jpg', 'Shampoo'),
                  _foodOrBodyCareOption('assets/makeuse55.jpg', 'Hair Oil'),
                  _foodOrBodyCareOption('assets/makeuse56.jpg', 'Baby Products'),
                  _foodOrBodyCareOption('assets/makeuse57.jpg', 'Cosmetic'),
                  _foodOrBodyCareOption('assets/makeuse58.jpg', 'Tooth Paste'),
                  _foodOrBodyCareOption('assets/makeuse59.jpg', 'Talcum Powder'),
                  _foodOrBodyCareOption('assets/makeuse60.jpg', 'Perfumes'),
                ],
              ),
            ),
          ),
    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('$item Selected!', style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,)),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
